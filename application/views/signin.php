...
<html lang="en">
	<head>
		...
		<link href="<?=base_url();?>assets/plugins/notify/css/notifIt-rtl.css" rel="stylesheet"/>
			...
			<div class="main-signin-wrapper">
				...
				<div class="wd-md-50p login d-none d-md-block page-signin-style p-5 text-white" >
					<div class="my-auto authentication-pages">
						<div>
							<h4>Notifikasi</h4>
							<h5 class="mb-4"><?=$this->session->flashdata('msg')?></h5>
						</div>
					</div>
				</div>
				<div class="p-5 wd-md-50p">
					<div class="main-signin-header">
						...
						<form action="<?=base_url()?>auth/signin" method="POST">
							<div class="form-group">
								<label>Email</label><input name="email" class="form-control" placeholder="Enter your email" type="text" value="<?=set_value('email')?>">
					...
					<div class="main-signin-footer mt-3 mg-t-5">
						<p class="text-center">Don't have an account? <a href="<?=base_url()?>auth/registration">Create an Account</a></p>
					</div>
				</div>
			</div>
			</div>
